...
export default function Category(props: CategoryProps) {
  return (
    <section
      ...
      `}
    >
      <div className="leading-100 brief-title mb-4 block text-xl font-extrabold text-tsiakkas-dark sm:text-2xl eq:hidden">
        {props.title}
      </div>
      <div
        className="text-lg font-extrabold text-tsiakkas-dark sm:text-xl"
