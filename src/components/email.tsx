...
export default function Email() {
  return (
    <div className="bg-white border-black border rounded-[10px] p-2.5 mb-12">
      {/* <HeadScene /> */}
      ...
      <div className="flex flex-end align-start justify-between mt-7 gap-1">
        <a
          className="shadow-md hover:bg-gray-200 transparent border border-black rounded-[18px] flex justify-between align-baseline gap-2 py-1.5 px-2.5 black mt-1"
          href={`${mailto}${subject}`}
        >
          <HiOutlineReply /> Reply
        </a>
        <a
          className="shadow-md hover:bg-gray-200 transparent border border-black rounded-md flex justify-between align-baseline gap-2 py-2 px-3 black mt-1"
